...
- `pyperformance` (implemented adapter): `cxc bench run --suite pyperformance ...` (interpreter comparators only: CPython/CinderX/PyPy; CI mode uses a focused benchmark subset for quick validation)

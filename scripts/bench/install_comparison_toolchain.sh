...
echo "  CINDERX_PYTHON=/path/to/cinderx-python PYPERF_BOOTSTRAP_PROFILE=cinderx-jit-all bash scripts/bench/run_quickstart_matrix.sh"
echo "  CINDERX_PYTHON=/path/to/cinderx-python PYPERF_BOOTSTRAP_PROFILES=cinderx-jit-all,cinderx-jit-auto,cinderx-jit-compile-after-n-calls PYPERF_BOOTSTRAP_JIT_COMPILE_AFTER_N_CALLS=40000 bash scripts/bench/run_quickstart_matrix.sh"
